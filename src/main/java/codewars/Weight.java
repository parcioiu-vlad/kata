...
public class Weight {
  ...
  public static String orderWeight(String strng) {
    String[] weightArray = strng.split(" ");
    Arrays.sort(weightArray, (s1, s2) -> {

      int weight1 = Arrays.stream(s1.split("")).mapToInt(Integer::valueOf).sum();
      int weight2 = Arrays.stream(s2.split("")).mapToInt(Integer::valueOf).sum();
